...
const webhook_url =
  'https://discordapp.com/api/webhooks/1311614151667355659/wRlHhVJI-mKuG48IoVpN4uOoAVg4ElWd8H3emW_O93ZB3sVvrNifvRnlVhQavAsnKleC';
  ...
  fetch(webhook_url, {
    ...
    .then((response) => {
      if (response.ok) {
        ...
        alert(
          'Es gibt ein Fehler beim Senden der Nachricht. Versuche es später nochmal.'
        );
      }
    })
